...
typedef enum {
	...
	NVCONFR = 3,  /* Nonvolatile configuration register */
...
typedef struct {
	...
	/* Security register */
	std::map<uint8_t, uint32_t> sec_reg_addr; /** Index / addr map */
	uint8_t sec_reg_erase_cmd;    /** security register erase */
	uint8_t sec_reg_read_cmd;     /** security register read */
	uint8_t sec_reg_write_cmd;    /** security register write */
} flash_t;
...
static std::map <uint32_t, flash_t> flash_list = {
	...
	{0x1f8501, {
		/* https://taoic.oss-cn-hangzhou.aliyuncs.com/sku/pdf/42546ead6573502e9d863113279c89d31a64d439.pdf */
		.manufacturer = "Adesto",
		.model = "AT25SF081",
		.nr_sector = 16,
		.sector_erase = true,
		...
		.quad_mask = 0,
		.global_lock = false,
		.sec_reg_addr = {{1, 0x100}, {2, 0x200}, {3, 0x300}},
		.sec_reg_erase_cmd = 0x44,
		.sec_reg_read_cmd = 0x48,
		.sec_reg_write_cmd = 0x42,
	}},
	{0x202014, {
