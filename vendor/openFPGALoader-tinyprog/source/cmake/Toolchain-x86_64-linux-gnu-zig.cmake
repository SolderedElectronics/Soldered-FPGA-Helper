# CMake toolchain for cross-compiling to Linux x86_64 using zig cc as a
# drop-in cross C/C++ compiler (no glibc sysroot management needed).
# Requires: zig on PATH (`brew install zig`).
# Usage: cmake -DCMAKE_TOOLCHAIN_FILE=cmake/Toolchain-x86_64-linux-gnu-zig.cmake
...
set(CMAKE_C_COMPILER "${ZIG_CC_DIR}/x86_64-linux-gnu-gcc-zig")
set(CMAKE_CXX_COMPILER "${ZIG_CC_DIR}/x86_64-linux-gnu-g++-zig")
